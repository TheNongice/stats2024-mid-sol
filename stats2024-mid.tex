...
\begin{solutionbox}
  ...
  \begin{align*}
    \underbrace{3}_{\text{เลือก $1^{st}$VP}} \times 
    \underbrace{5}_{\text{เลือก $2^{nd}$VP}} \times 
    \underbrace{6}_{\text{เลือกคนเป็นประธาน}} \times 
    \underbrace{5}_{\text{เลือกคนเป็นเลขา}} = 450 \text{ วิธี}
  \end{align*}
...
\begin{solutionbox}
  ...
  ส่วนถัดไปคือการหาค่า ${n(E)}$ สามารถหาได้โดยให้เริ่มหยิบดูผลลัพธ์ที่สามารถออกได้ของลูกเต๋าที่มีข้อจำกัดมากที่สุดก่อน ในที่นี้คือลูกเต๋าหมายเลข (3), (2), (1) ตามลำดับ ซึ่งสามารถคำนวณวิธีได้ดังนี้
  \begin{align*}
    \underbrace{4}_{\text{ลูกเต๋า (3) ออกผลได้}} \times 
    \underbrace{4}_{\text{ลูกเต๋า (2) ออกผลได้}} \times 
    \underbrace{4}_{\text{ลูกเต๋า (1) ออกผลได้}} = 4^3 = 64 \text{ วิธี}
  \end{align*}
...
\begin{solutionbox}
  ...
  NEED\_HELP: anyone pls help me. i can't describe it by myself! \texttt{:(}
