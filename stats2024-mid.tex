...
\begin{solutionbox}
  ...
  \end{itemize}
  เพื่อความรวดเร็วระหว่างการสอบ ให้แทนค่าสำหรับตัวแปร $n, k$ มีค่าห่างที่ห่างกัน ณ ที่นี้ขอสมมติค่าเป็น $n=8, k=5$ จากรูปสมการเศษส่วนด้านบนจึงได้ว่า $\frac{7!}{4!}$ ถัดไปทำการหาว่าตัวเลือกในข้อสอบใดมีค่าตรงกับเศษส่วนข้างต้น ซึ่งแทนที่ตัวเลขได้ดังนี้...
  \begin{itemize}
...
(โจทย์ และ Solution ข้อที่ 42 อยู่หน้าถัดไป)
